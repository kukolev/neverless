...
import neverless.domain.game.mapobject.building.AbstractBuilding;
import neverless.domain.game.mapobject.monster.Goblin;
import neverless.domain.game.mapobject.road.Road;
import neverless.domain.game.mapobject.tree.FirTree;
import neverless.domain.game.mapobject.building.LargeVillageHouse;
import neverless.domain.game.mapobject.building.LittleVillageHouse;
import neverless.domain.game.mapobject.building.LongVillageHouse;
import neverless.domain.repository.MapObjectsRepository;

import neverless.loader.npc.OldManBuilder;
